...
val HmDarkBarTrack       = Color(0x33FFFFFF)   // white @ 20% — Progress-Track auf dunkler Card
val HmDarkCardBorder     = Color(0x00FFFFFF)   // transparent — dunkle Card hebt sich schon von Background ab
...
val HmLightBarTrack      = Color(0xFFE3E4EA)   // sichtbarer Grau-Track auf #F4F5F8 Background
val HmLightCardBorder    = Color(0x1F1B1F26)   // 12% Schwarz — feine Hairline um weiße Cards
