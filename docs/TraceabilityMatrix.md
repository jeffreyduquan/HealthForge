...
| REQ-INGR-003 | P1 / P7.S3 Slice 2 | ✅ | `server/etl/Importers.kt::SighiImporter` re-implementiert als Keyword-Matcher (substring-/akzent-insensitiv), liest `seed/sighi.csv` (270 Keywords, kuratiert aus SIGHI-Merkblatt v2021-11-17 PDF). End-to-End ✅ 2026-05-29: ETL `POST /admin/v1/etl/run?source=SIGHI` → `etl_runs.status=SUCCESS`, 477/632 Ingredients erhielten Score 0/1/3 (Verteilung: 284 gut/38 unsicher/155 zu meiden/155 unbekannt). Spot-Check: Salami=3, Tomate=3, Avocado=3, Spinat=3, Camembert=3, Mozzarella=0, Apfel=0, Hähnchenbrust=0, Knoblauch=0, Kabeljau=0. |
